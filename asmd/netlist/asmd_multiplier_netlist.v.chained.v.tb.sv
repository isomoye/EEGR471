/*
    ...
    Do not modify.
    Generated on: 2023-12-02 21:21:28
*/
...
module testbench;
    ...
    asmd_multiplier_netlist uut(
        .\tck ( \tck ) , .\product ( \product ) , .\test ( \test ) , .\word1 ( \word1 ) , .\reset ( \reset ) , .\clk ( \clk ) , .\ready ( \ready ) , .\word0 ( \word0 ) , .\sout ( \sout ) , .\sin ( \sin ) , .\shift ( \shift ) , .\start ( \start ) 
    ); 

    wire[38:0] __serializable__ =
        39'b011010011100100011111000000111111000110;
    reg[38:0] __serial__;
    integer i;
    initial begin
        `ifdef VCD
